...
const pages = {
  ...
  'product-web': 'product/web.html',
  'product-extension': 'product/extension.html',
  'product-desktop': 'product/desktop.html',
  pricing: 'product/pricing.html',
  'product-enterprise': 'product/enterprise.html',
  // Resources
  ...
  'docs-tools': 'resources/docs/tools.html',
  'docs-yaml': 'resources/docs/yaml.html',
  'docs-orchestrator': 'resources/docs/orchestrator.html',
  'docs-scheduler': 'resources/docs/scheduler.html',
  'docs-mcp': 'resources/docs/mcp.html',
